...
try:
    ...
    if num_tables > 0:
        ...
        error_message_to_send = "During running of: dw_source_transfer_no_change_check glue job, the following " + str(num_tables) \
            + " static tables: (" + table_list + \
    ...
    error_message_to_send = "Exception occurred in: dw_source_transfer_no_change_check glue job"
    sns_topic = "arn:aws:sns:us-west-2:511539536780:Glue-Error-Messages"
    msg_id = publish_message(sns_topic, error_message_to_send, error_email_subject)
